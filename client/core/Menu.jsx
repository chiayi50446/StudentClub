        ...
        <StyledToolbar variant="dense" disableGutters>
          ...
          >
            ...
            <Box sx={{ display: { xs: "none", md: "flex" } }}>
              ...
              <Link to="/about">
                <Button sx={{ p: 1 }} style={isActive(location, "/about")}>
                  About
                </Button>
              </Link>
              <Link to="/eventList">
              ...
              <Link to="/users">
                <Button sx={{ p: 1 }} style={isActive(location, "/users")}>
                  Users
                </Button>
              </Link>
            </Box>
          ...
          >
            {!auth.isAuthenticated() && (
              <>
                <Link to="/signin">
                  <Button sx={{ p: 1 }} style={isActive(location, "/signin")}>
                    Sign In
                  </Button>
                </Link>
                <Link to="/signup">
                  <Button sx={{ p: 1 }} style={isActive(location, "/signup")}>
                    Sign up
                  </Button>
                </Link>
              </>
